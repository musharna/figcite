...
def test_a_capture_from_an_unreadable_browser_says_so(monkeypatch):
    ...
    out = browser.resolve_from_capture({"process": "msedge", "title": "A paper - Microsoft Edge"})
...
def test_a_firefox_capture_is_not_told_its_browser_is_unreadable(monkeypatch):
    ...
    out = browser.resolve_from_capture({"process": "firefox", "title": "A paper - Mozilla Firefox"})
